    ...
    while True:
        for click in pygame.event.get():
            if click.type == pygame.KEYDOWN:
                ...
                help4_text = help_font.render('Mechanics:', True, constants.WHITE)
                ...
                help6_text = help2_font.render('Eat apples will make the snake decrease.', True, constants.WHITE)
                help6_text_rect = help6_text.get_rect()
                help6_text_rect.center = (300, 400)

                help7_text = help2_font.render('SAVE THE SNAKE´S BABY!', True, constants.WHITE)
                help7_text_rect = help7_text.get_rect()
                help7_text_rect.center = (300, 450)

                exit_help_text = help2_font.render('Press "i" to back to menu.', True, constants.WHITE)
