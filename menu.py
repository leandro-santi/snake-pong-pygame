    ...
    while True:
        for click in pygame.event.get():
            if click.type == pygame.KEYDOWN:
                ...
                t_text = t_font.render('SNAKE+=PONG', True, constants.WHITE)
                ...
                exit_text = exit_font.render('Press "ESC" to exit', True, constants.WHITE)
                exit_text_rect = exit_text.get_rect()
                exit_text_rect.center = (300, 350)

                credits_font = pygame.font.Font('assets/fonts/PressStart2P.ttf', 12)
                credits_text = credits_font.render('© 2021 by: leosanti', True, constants.WHITE)
                ...
                snake_pic = pygame.image.load("assets/images/snake_pic.png")
                menu_screen.blit(snake_pic, (200, 420))
